 ...
 *
 * Everything else in this folder is internal. A caller composes a middleware or a service from
 * here; nothing outside reaches for a verifier, a cookie helper or a hasher directly, and
 * nothing is exported that nothing outside uses.
 */
...
export { createChildSessionService, CHILD_SESSION_IDLE_MS } from './child-session.service';
export type { ChildSessionService } from './child-session.service';
export { createChildCredentialService, MAX_ATTEMPTS } from './pin.service';
export type { ChildCredentialService, ChildLoginAttempt } from './pin.service';
