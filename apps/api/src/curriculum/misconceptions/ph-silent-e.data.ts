...
export const PH_SILENT_E_MISCONCEPTIONS: readonly AuthoredMisconception[] = [
  {
    ...
    model: 'the short word read, then the e card added and read again',
  ...
  },
  {
    ...
    approach: 'worked-example',
    model: 'the pair cap and cape read one after the other',
  ...
  },
  {
    ...
    model: 'a CVC word with no e at all, read on its own',
