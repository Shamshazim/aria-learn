...
/**
 * How a legacy topic gets a place in the skill graph.
 *
...
/** A legacy `level` is the grade number; the product's grades are strings. */
export function gradeForLevel(level: number): Grade | null {
